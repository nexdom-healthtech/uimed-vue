...
| ------------ | ---------------- | ------- | ------------------------------------------------------------------------- |
| `modelValue` | `T` \| `boolean` |         | Valor selecionado pela caixa de seleção.                                  |
...
| `trueValue`  | `T`              | `true`  | Valor aplicado ao `modelValue` quando a caixa de seleção está marcada.    |
| `falseValue` | `T`              | `false` | Valor aplicado ao `modelValue` quando a caixa de seleção está desmarcada. |
